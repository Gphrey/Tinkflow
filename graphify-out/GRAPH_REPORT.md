...
## Summary
- 471 nodes · 711 edges · 55 communities (26 shown, 29 thin omitted)
...
10. `TranscriptionRecord` - 9 edges
...
### Community 0 - "lib.rs"
Cohesion: 0.11
Nodes (46): App, CorrectionEntry, DictationResult, DictationResultStore, DownloadCancelFlag, State, ActiveHotkeyId, add_correction() (+38 more)
...
### Community 11 - "Result"
Cohesion: 0.29
Nodes (12): Enigo, Option, Result, Self, String, DictationResult, copy_text_to_clipboard(), inject_via_clipboard() (+4 more)
...
## Knowledge Gaps
- **96 isolated node(s):** `$schema`, `identifier`, `description`, `main`, `core:default` (+91 more)
...
- **Why does `update_app_settings()` connect `lib.rs` to `Result`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `context_with_profile()` connect `.init_on_main_thread` to `Result`?**
